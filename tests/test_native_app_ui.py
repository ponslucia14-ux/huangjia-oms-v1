...
class NativeAppUITests(unittest.TestCase):
    ...
    def test_native_app_uses_runtime_home_endpoint_without_demo_state(self):
        ...
        self.assertIn("127.0.0.1:8787/api/oms/home", runtime_config)
        self.assertIn("127.0.0.1:8787/api/oms/local-owner-access", runtime_config)
    ...
    def test_interaction_layer_routes_state_and_api_bridge_are_active(self):
        ...
        self.assertIn("127.0.0.1:8787/api/oms/execute", self.read("oms-config.js"))
