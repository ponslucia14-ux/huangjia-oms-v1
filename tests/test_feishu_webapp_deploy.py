...
class FeishuWebAppDeployTests(unittest.TestCase):
    ...
    def test_feishu_webapp_manifest_uses_https_web_url(self):
        ...
        self.assertEqual(manifest["oauth_redirect_uris"], ["https://api.wonderfulseki.cn/"])
        ...
        self.assertEqual(manifest["h5_security"]["js_safe_domains"], ["api.wonderfulseki.cn"])
        self.assertEqual(manifest["h5_security"]["oauth_redirect_domains"], ["api.wonderfulseki.cn"])
        self.assertEqual(manifest["h5_security"]["h5_trusted_domains"], ["api.wonderfulseki.cn"])
